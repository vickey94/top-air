...
public class Flight {
    ...
    private String flightNoShort;  //航班号
    private String depAirport;     //出发机场三字号
    private String depCity;        //出发城市三字号
    private String arrAirport;     //目的机场三字号
    private String arrCity;        //目的城市三字号
    private String depTime;        //计划出发时间
    private String arrTime;        //计划到达时间
    private String arrday;         //计划到达日
    private String flyingTime;     //计划飞行时间
    private String actDepTime;     //实际出发时间
    private String actArrTime;     //实际到达时间
    private String actArrday;      //实际到达日
